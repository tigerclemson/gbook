...
<Card subTitle ="보험위험의 유의성 평가 시 고려해야 할 사항" style={{ backgroundColor: 'var(--teal-50)'}}>
* [분리 가능한 _**내재파생상품**_](2.2.1.md#undefined)  : IFRS 9 (금융상품) 적용;
* [보험요소와 구분되는 _**투자요소**_](2.2.1.md#undefined-1) : IFRS 9 (금융상품) 적용
* 보험요소와 구분되는 [_**재화 및 보험계약서비스 이외의 서비스요소**_](2.2.1.md#undefined-2) : IFRS 15 (고객과의계약에서생기는수익) 적용;
* 그 외 [_**보험요소**_](2.2.1.md#undefined-3)  : IFRS 17 보험계약
</Card>
